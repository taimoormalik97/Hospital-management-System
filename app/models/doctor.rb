class Doctor < User
  ...
  validates :consultancy_fee, numericality: { greater_than: 0 }
  validates :speciality, length: { in: 3..35 }
  validates :registration_no, numericality: { only_integer: true }, length: { maximum: 10 }, uniqueness: { scope: :hospital_id }, case_sensitive: false
